...
| 文件 | 说明 | 大小 |
|------|------|------|
| `安装包/WorkBuddy-v1.2-release.apk` | **推荐安装** 签名 Release 包 | 4.6 MB |
| `安装包/WorkBuddy-v1.2-release.apk` | 调试用 Debug 包 | 5.6 MB |
...
git commit -m "Add WorkBuddy Android wrapper v1.2.0"
